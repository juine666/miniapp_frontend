...
CREATE TABLE IF NOT EXISTS permissions (
    ...
    code VARCHAR(100) NOT NULL UNIQUE COMMENT '权限代码，如 order:view, product:create',
    name VARCHAR(100) NOT NULL COMMENT '权限名称，如 查看订单, 创建商品',
    permission_group VARCHAR(50) NOT NULL COMMENT '权限分组，如 订单管理, 商品管理',
...
CREATE TABLE IF NOT EXISTS roles (
    ...
    code VARCHAR(50) NOT NULL UNIQUE COMMENT '角色代码，如 ADMIN, EDITOR',
    name VARCHAR(100) NOT NULL COMMENT '角色名称，如 管理员, 编辑员',
